...
const rulesStep1: FormRules = {
  ...
  'addressRequest.postalCode': [{ required: true, message: t('register.postalCode'), trigger: 'blur' }],
...
const rulesStep2: FormRules = {
  ...
  confirmPassword: [
    ...
    { validator: () => form.confirmPassword === form.adminPassword, message: t('register.confirmPassword'), trigger: 'blur' },
  ],
  acceptTerms: [{ type: 'boolean', required: true, message: t('register.acceptTerms'), trigger: 'change' }],
}
      ...
      <div class="max-w-2xl mx-auto p-6 space-y-4">
        ...
        <template v-if="step === 1">
          ...
          <n-form-item path="subscriptionTier" :label="t('register.subscriptionTier')">
            <n-select v-model:value="form.subscriptionTier" :options="[
          ...
          <n-form-item :label="t('register.addressTitle')" path="addressRequest.street">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 w-full">
              <n-input v-model:value="form.addressRequest.street" :placeholder="t('register.street')" />
              <n-input v-model:value="form.addressRequest.city" :placeholder="t('register.city')" />
              <n-input v-model:value="form.addressRequest.state" :placeholder="t('register.state')" />
              <n-input v-model:value="form.addressRequest.postalCode" :placeholder="t('register.postalCode')" />
              <n-input v-model:value="form.addressRequest.country" :placeholder="t('register.country')" />
            </div>
          </n-form-item>
